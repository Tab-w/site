...
import com.eric.site.web.entity.UserRoleExample.Criteria;
import com.eric.site.web.entity.UserRoleExample.Criterion;
...
public class UserRoleSqlProvider {
    ...
    public String countByExample(UserRoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sec_user_role");
