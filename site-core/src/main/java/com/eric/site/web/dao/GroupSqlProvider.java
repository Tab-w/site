...
import com.eric.site.web.entity.GroupExample.Criteria;
import com.eric.site.web.entity.GroupExample.Criterion;
...
public class GroupSqlProvider {
    ...
    public String countByExample(GroupExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sys_group");
