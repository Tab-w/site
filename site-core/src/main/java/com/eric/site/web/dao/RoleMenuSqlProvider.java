...
import com.eric.site.web.entity.RoleMenuExample.Criteria;
import com.eric.site.web.entity.RoleMenuExample.Criterion;
...
public class RoleMenuSqlProvider {
    ...
    public String countByExample(RoleMenuExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sec_role_menu");
